      ...
      <div className="container mx-auto p-5">
        ...
        <div className="bg-white  rounded-3xl p-3 mt-5 ">
          <Slider {...settings}>
            <div className="w-full rounded-2xl h-80 ">
              <Image
                width={500}
                height={550}
                src="/my-journey/carousel-img-14.png"
                alt="Video thumbnail"
            ...
            <div className="w-full rounded-2xl h-80">
              <Image
                width={500}
                height={550}
                src="/my-journey/carousel-img-15.jpeg"
                alt="Video thumbnail"
                className="w-full h-full rounded-3xl img-s"
              />
            </div>
            <div className="w-full rounded-2xl h-80">
              <Image
                width={500}
                height={550}
                src="/my-journey/carousel-img-13.jpeg"
                alt="Video thumbnail"
                className="w-full h-full rounded-3xl img-s"
              />
            </div>
          ...
          <p className="text-black text-xl merriweather-regular text-left p-5 mt-5">
            ...
            career by being elected to the Kerala Legislative Assembly from the
            Paravur seat. His leadership qualities were recognized, and he was
            chosen as the whip of the Congress Legislative Party. During this
            tenure, he successfully completed a large-scale drinking water
            project in his constituency, benefiting over 2.5 lakh people.
          </p>
