          ...
          <div className="lg:flex pb-5">
            <div className="lg:w-[80%]">
              <p className="text-black text-xl merriweather-regular text-left p-5 mt-5">
                VD Satheeshan&apos;s political career reached new heights during this
                phase. He was re-elected to the assembly and, as a testament to
                his leadership capabilities, was elected as the Chairman of the
                Public Estimate Committee of the legislative assembly.
                Additionally, he was nominated to chair the Joint Assembly
                Committee responsible for investigating allegations against the
                former Chief Minister. His influence expanded beyond the state,
                as he was appointed as the Secretary of the All India Congress
                Committee and also as the Vice President of the Kerala Pradesh
                Congress Committee. In collaboration with other MLAs, he
                initiated the Green movement.
              </p>
            ...
            <div className="lg:w-[20%]">
              <Image
                width={500}
                height={550}
                src="/my-journey/total-votes-2012.svg"
                alt="Video thumbnail"
