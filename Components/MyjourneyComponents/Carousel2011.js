      ...
      <div className="container mx-auto p-5">
        ...
        <div className="bg-white  rounded-3xl p-3 mt-5 ">
          ...
          <p className="text-black text-xl merriweather-regular text-left p-5 mt-5">
            ...
            phase. He was re-elected to the assembly and, as a testament to his
            leadership capabilities, was elected as the Chairman of the Public
            Estimate Committee of the legislative assembly. Additionally, he was
            nominated to chair the Joint Assembly Committee responsible for
            investigating allegations against the former Chief Minister. His
            influence expanded beyond the state, as he was appointed as the
            Secretary of the All India Congress Committee and also as the Vice
            President of the Kerala Pradesh Congress Committee. In collaboration
            with other MLAs, he initiated the Green movement
          </p>
